...
def train(train_loader, model, optimizer, epoch, save_path, writer):
    ...
    try:
        for i, (images, gts,edges) in enumerate(train_loader, start=1):
            ...
            loss_edge = edge_loss(preds[-1],edges)
...
if __name__ == '__main__':
    ...
    parser.add_argument('--train_root', type=str, default='/home/rec/Desktop/SInet/123/VT5000/Train/',
                        help='the training rgb images root')
    # parser.add_argument('--val_root', type=str, default='/home/rec/Desktop/SInet/123/VT5000/Test/',
    #                     help='the test rgb images root')
    parser.add_argument('--save_path', type=str,
                        default='./snapshot/New/',
