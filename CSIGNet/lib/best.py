...
class Network(nn.Module):
    ...
    def forward(self, x):
        ...
        return S_g_pred, S_5_pred, S_4_pred, S_3_pred,F.interpolate(edge_p,scale_factor=4,mode='bilinear')
...
#     net = Network(imagenet_pretrained=True)
#     # net.load_state_dict(torch.load('/home/rec/Desktop/SInet/SINet-V2-main/snapshot/Net_epoch_best.pth'))
#     net.eval()
#
#     total=sum([i.nelement() for i in net.parameters()])
#     print(total/1e6)
